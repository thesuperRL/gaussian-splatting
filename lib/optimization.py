...
def optimize(img_path, size = [256, 256], splats = 1000, iter = 1000, verbose = False, showper = 20):
...
if __name__ == "__main__":
    optimize("images/shuak.png", size = [256, 256], splats = 2000, iter = 2000, showper = 20)